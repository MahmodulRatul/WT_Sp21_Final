	...
	function validPass($password)
	 {
		...
		if (isset($_POST["edit_seller"])){
			...
			if(!$hasError)
		   {
			...
			editSeller($_POST["id"],$fname,$lname,$uname,$ad,$gender,$email,$pass,$number,$type);
		...
		{
			$query="INSERT INTO users VALUES (NULL,'$fname','$lname','$uname','$ad','$gender','$email','$pass','$number','seller')";
			execute($query);
		...
		function editSeller($id,$fname,$lname,$uname,$ad,$gender,$email,$pass,$number,$type){
			$query="UPDATE users
                SET fname='$fname',
                lname='$lname',
                uname='$uname',
