        ...
        <form action="" onsubmit="return validateDelivery()" method="post">
            <table>
				...
				<tr>
					...
					<td>:<input type="hidden" name="id" value="<?php echo $deliveryman["id"];?>">  
					<input type="radio" id="gender" name="gender" value="Male"><?php if($deliveryman["gender"]=="Male");?><span>Male</span>
					    <input type="radio" id="gender" name="gender" value="Female"><?php if($deliveryman["gender"]=="Female");?><span>Female</span>
				...
				<tr>
					<td><input type="submit" name="edit_man" value="Edit Deliveryman"></td>
				</tr>
